...
|---------|----------|---------|
| Encabezado | `# Título 1` `## Título 2` `### Título 3` | # Título 1 ## Título 2 |
| Negrita | `**texto**` o `__texto__` | **Negrita** |
| Cursiva | `*texto*` o `_texto_` | *Cursiva* |
| Listas | `- Item` o `* Item` | - Item 1 - Item 2 |
| Listas numeradas | `1. Item` | 1. Paso 1 2. Paso 2 |
...
| Bloques de código | `` `c `` `` código `` ` `` | `` `int main() { return 0; }` `` |
...
4. Clona el repositorio a tu máquina: git clone <https://github.com/usuario/repositorio.git>
